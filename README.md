...
![coverage](https://REDACTED/team-6/prod-backend/badges/master/coverage.svg?min_good=55&min_acceptable=40&min_medium=30) ![build](https://REDACTED/team-6/prod-backend/badges/master/pipeline.svg)
...
[Backend repository](https://REDACTED/team-6/prod-backend/)
[Mobile respotirry](https://REDACTED/team-6/mentorapp)

## 🖥️ Мониторинг системы

Для мониторинга бизнесс показателей используется [Grafana](https://prod-team-6-a36eo8k0.REDACTED/grafana)
...
[🔗 API Docs](https://prod-team-6-a36eo8k0.REDACTED/docs)
